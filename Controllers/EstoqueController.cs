...
namespace EsbocoEstoque.Controllers
{
    public class EsbocoController : Controller
    {
        ...
        public IActionResult Delete(int id)
        {
            ...
            {
                TempData["mensagemSucesso"] = $"Os dados do vinho {vinhoConsultado.Nome} foram removidos com sucesso";
            }
            else
            {
